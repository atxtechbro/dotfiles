...
# Create claude alias that includes the MCP config and knowledge directory
# This allows MCP servers and global knowledge base to be available from any directory
